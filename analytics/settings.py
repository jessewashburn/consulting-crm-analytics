...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.yosugfmarodnempvvbru',
...
S3_BUCKET_NAME = os.getenv('S3_BUCKET_NAME', 'crm-events-archive')

# Event Processing Configuration
EVENT_POLLING_INTERVAL = int(os.getenv('EVENT_POLLING_INTERVAL', '30'))
